...
public abstract class ChartTouchView extends ChartGraphicalView implements
		IChartZoom {
	private String TAG = "ChartTouchView";
	...
	public ChartTouchView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public ChartTouchView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public ChartTouchView(Context context, AttributeSet attrs, int defStyleAttr) {
