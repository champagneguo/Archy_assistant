...
public abstract class ChartGraphicalView extends View {

	public String TAG = "ChartGraphicalView";
	protected int mScrWidth = 0;
	protected int mScrHeight = 0;

	public ChartGraphicalView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}

	public ChartGraphicalView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		initView();
	}
